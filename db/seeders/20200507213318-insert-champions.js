...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('Champions', [
      ...
      { championId: 136, championName: "Aurelion Sol", createdAt: new Date(), updatedAt: new Date() },
      ...
      { championId: 145, championName: "Kai'Sa", createdAt: new Date(), updatedAt: new Date() },
      ...
      { championId: 64, championName: "Lee Sin", createdAt: new Date(), updatedAt: new Date() },
      ...
      { championId: 11, championName: "Master Yi", createdAt: new Date(), updatedAt: new Date() },
      { championId: 21, championName: "Miss Fortune", createdAt: new Date(), updatedAt: new Date() },
      ...
      { championId: 223, championName: "Tahm Kench", createdAt: new Date(), updatedAt: new Date() },
      ...
      { championId: 4, championName: "Twisted Fate", createdAt: new Date(), updatedAt: new Date() },
      ...
      { championId: 62, championName: "Wukong", createdAt: new Date(), updatedAt: new Date() },
      ...
      { championId: 5, championName: "Xin Zhao", createdAt: new Date(), updatedAt: new Date() },
